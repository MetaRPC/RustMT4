...
> **Hands-on Quick Start** - Create a working trading project with MetaTrader 4 and RustMT4 from scratch.
...
```
use metarpc_mt4::MT4Account;

// Account ID generation (GetId) and authentication are handled automatically
let mut account = MT4Account::new(user, password, grpc_server, apiKey);
