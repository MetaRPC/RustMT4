...
> **Complete guide** to working with real-time subscriptions in PyMT4
...
- [on_symbol_tick](../MT4Account/6.%20Streaming_Methods/on_symbol_tick.md)
- [on_trade](../MT4Account/6.%20Streaming_Methods/on_trade.md)
...
```python
class PriceMonitor:
    def __init__(self, account: MT4Account):
...
When working with gRPC streaming in PyMT4, understanding the stream lifecycle is critical:
...
- MT4 terminal continues sending updates
...
import asyncio
from MetaRpcMT4 import MT4Account
import MetaRpcMT4.mt5_term_api_subscriptions_pb2 as sub_pb2
...
### How Python Streaming Works in MT4Account
...
* **[Streaming Methods Overview](../MT4Account/6.%20Streaming_Methods/Streaming_Methods.Overview.md)** - Complete streaming methods documentation
* **[on_symbol_tick](../MT4Account/6.%20Streaming_Methods/on_symbol_tick.md)** - Tick streaming reference
* **[on_trade](../MT4Account/6.%20Streaming_Methods/on_trade.md)** - Trade events reference
